...
<ul>
	...
	<li><i>result_errors.log</i>: A list of errors for the run regarding the results</li>
	...
	<li><i>args_overview.txt</i>: A table that shows all arg-parameters given to OO.</li>
