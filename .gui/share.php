			...
			if(count($result_names) && count($result_min_max)) {
				...
				$tab_definitions = [
					...
					'add_simple_pre_tab_from_file' => [
						...
						["$run_dir/progressbar", "Progressbar", "tab_progressbar_log"],
						["$run_dir/verbose_log.txt", "Verbose log", "tab_verbose_log"],
						["$run_dir/job_submit_durations.txt", "Submit times", "tab_job_submit_durations"],
						["$run_dir/generation_times.txt", "Gen. times", "tab_job_generation_times"],
					],
