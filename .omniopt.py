...
VALID_ACQUISITION_CLASSES: list = ["LogExpectedImprovement", "ExpectedImprovement", "qExpectedImprovement", "qNoisyExpectedImprovement", "qLogExpectedImprovement", "qLogNoisyExpectedImprovement", "qMaxValueEntropy", "ConstrainedExpectedImprovement", "ProximalAcquisitionFunction", "qMultiFidelityMaxValueEntropy", "qMultiFidelityKnowledgeGradient"]
...
try:
    ...
    with console.status("[bold green]Loading botorch...") as status:
        ...
        from botorch.acquisition import LogExpectedImprovement, ExpectedImprovement, qExpectedImprovement, qNoisyExpectedImprovement, qLogExpectedImprovement, qLogNoisyExpectedImprovement, qMaxValueEntropy, ConstrainedExpectedImprovement, ProximalAcquisitionFunction, qMultiFidelityMaxValueEntropy, qMultiFidelityKnowledgeGradient
