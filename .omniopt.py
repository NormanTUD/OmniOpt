...
SUPPORTED_MODELS: list = ["SOBOL", "FACTORIAL", "SAASBO", "LEGACY_BOTORCH", "BOTORCH_MODULAR", "UNIFORM", "BO_MIXED", "EB_ASHR", "EMPIRICAL_BAYES_THOMPSON", "SAAS_MTGP", "ST_MTGP", "THOMPSON"]
