...
to_test = {
    ...
    ".pareto.py": {
        ...
        "pareto_front_general(np.array([1,2,0.5]), np.array([1,2,1]), True, True)": np.array([2]),
        "pareto_front_general(np.array([1, 2, 0.5]), np.array([1, 2, 1]), True, True)": np.array([2]),
        "pareto_front_general(np.array([1,2,3,0.5]), np.array([1,2,0.5,1]), True, True)": np.array([2, 3]),
        "pareto_front_general(np.array([1,1,1]), np.array([1,1,1]), True, True)": np.array([0, 1, 2]),
        "pareto_front_general(np.array([1,2,0.5]), np.array([1,0.5,2]), False, False)": np.array([0, 1, 2]),
        "pareto_front_general(np.array([1,2,0.5]), np.array([1,0.5,2]), True, False)": np.array([2]),
        "pareto_front_general(np.array([5,2,3,1,4]), np.array([1,5,2,3,4]), True, True)": np.array([0, 2, 3]),
    }
}
