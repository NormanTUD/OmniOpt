...
?>
        <script>
            ...
            var tableData = [
                ...
                { label: "Live-Share", id: "live_share", type: "checkbox", value: 0, "info": "Automatically uploads the results to our servers for 30 days, so you can trace the output live in the browser, without needing SSH. <i>By using this, you agree to have your username published online.</i>" },
