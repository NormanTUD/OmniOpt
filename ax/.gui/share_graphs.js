...
function add_load_worker_cpu_button () {
	$("#main_tabbed").after("<button id='load_worker_cpu_button' class='invert_in_dark_mode' style='width: 300px' onclick='plot_worker_cpu_ram()'>Load Worker/CPU graphs</button>\n");
