<?php
	...
	$acceptable_file_names = ["best_result.txt", "job_infos.csv", "parameters.txt", "results.csv", "ui_url.txt", "cpu_ram_usage.csv", "get_next_trials.csv", "run_uuid", "outfile.txt", "oo_errors.txt", "evaluation_errors.log", "outfile"];
