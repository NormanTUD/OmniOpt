...
The current folder where you run the <pre><code class="language-bash">./omniopt_docker</code></pre> from is mounted inside docker as <code class="language-bash">/var/opt/omniopt/docker_user_dir</code>
