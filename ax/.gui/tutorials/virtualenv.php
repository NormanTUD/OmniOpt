...
<h2 id="where_is_omniopts_venv">Where will OmniOpt install it's dependencies to?</h2>

<p>By default, OmniOpt tries to install the dependencies in a folder in your home folder, so that you only need to install OmniOpt once, and all other installations can access this virtualenv.</p>
...
<p>You need to do this every time before you start OmniOpt as well, since without that shell variable (that has to be exported!) it will try to do it from your home again.</p>
