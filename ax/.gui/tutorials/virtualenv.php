...
<p>The default folder will be created like this: <span class="invert_in_dark_mode"><code class="language-bash">.omniax_$(uname -m)_$(python3 --version | sed -e 's# #_#g')$_cluster</code></span>, while <samp>uname -m</samp> yields to your CPU architecture (usually <samp>x86_64</samp>,
...
<pre class="invert_in_dark_mode"><code class="language-bash">export root_venv_dir=/path/where/it/should/be/installed/to</code></pre>
