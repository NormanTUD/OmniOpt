...
optional.add_argument('--all_at_once', help='In the 2nd phase, should all workers be generated at once? Or one after another? Default is one after another', action='store_true', default=True) # TODO: default false?
