...
@beartype
def get_ret_value_from_pd_csv(pd_csv: str, _type: str, _column: str, _default: Union[None, float, int]) -> Tuple[Union[int, float], bool]:
    found_in_file = False
    ret_val = None
...
@beartype
def insert_job_into_ax_client(old_arm_parameter: tuple[str, str] | tuple[str, float, tuple[str, int], tuple[str, None]], old_result: dict, hashed_params_result: Union[None, int, str, float]) -> None: # pragma: no cover
