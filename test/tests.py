...
objective_function_mongodb_output = mongo_db_objective.objective_function_mongodb([testprojectname, [5, 6, 7, 8], testprojectdir])
...
class TestStringMethods(unittest.TestCase):
    def test_worker_file_creation(self):
        ...
        command_output = workerstuff.get_start_worker_command(start_worker_command, testprojectname, myconf, data, testprojectdir)
